...
#define	SG_DMA_DESCRIPTORS_WIDTH    0x100000//0xFFFF
#define	MEMBLOCK_WIDTH              0x1FFFFFF 	//size of mem used by s2mm and mm2s (32 MB)
#define	BUFFER_BLOCK_WIDTH          0x20000//0x7D0000	//size of memory block per descriptor in bytes
#define DEST_MEM_BLOCK				0x1400000
