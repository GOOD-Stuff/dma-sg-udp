...
HD_PWD='D:/Projects/z_eth_4/z_eth.runs/bd_8314_eth_mac_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_8314_eth_mac_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source bd_8314_eth_mac_0.tcl
