...
HD_PWD='D:/Projects/z_eth_4/z_eth.runs/z_eth_xbar_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log z_eth_xbar_3.vds -m64 -mode batch -messageDb vivado.pb -notrace -source z_eth_xbar_3.tcl
