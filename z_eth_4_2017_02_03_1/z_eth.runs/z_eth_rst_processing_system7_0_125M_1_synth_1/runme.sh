...
HD_PWD='D:/Projects/z_eth_4/z_eth.runs/z_eth_rst_processing_system7_0_125M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log z_eth_rst_processing_system7_0_125M_1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source z_eth_rst_processing_system7_0_125M_1.tcl
