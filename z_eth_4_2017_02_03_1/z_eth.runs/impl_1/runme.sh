...
HD_PWD='C:/Projects/z_eth_4_2017_02_03_1/z_eth.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log z_top.vdi -applog -m64 -messageDb vivado.pb -mode batch -source z_top.tcl -notrace
